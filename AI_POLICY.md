...
This policy is inspired by [Fedify's AI policy][1], which is itself inspired
by [Ghostty's AI policy][2].

The Dojang project has the following rules for AI usage:
...
These rules apply only to outside contributions to Dojang.  Maintainers are
...
Please remember that Dojang is maintained by humans.
...
Dojang is written with plenty of AI assistance, and many maintainers embrace
